  ...
  return (
      <div className='p-5 bg-zinc-800 mt-7 rounded'>
        <form className='flex flex-wrap w-full items-start justify-between'>
            ...
            <div className='w-1/2'>
                <h3>Description</h3>
                <textarea className="w-full h-44 text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border border-gray-400 mb-4 " name="" id="" cols="30" rows="10"></textarea>
            </div>
