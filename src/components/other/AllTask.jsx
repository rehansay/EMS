...
const AllTask = () => {
  return (
    <div className='bg-[#1c1c1c] p-5 roundedmt-5'>
        <div className=' bg-slate-800 border-l-4 border-cyan-500 hover:bg-[#273449] rounded-xl  border mb-2 py-2 px-4 flex justify-between'>
            <h2>Sarthak</h2>
            <h3> Make a UI design</h3>
            <h4 className='rounded-full'>Status</h4>
        </div>
